...
def get(self, request, cedula = None):
    try:
        ...
        personsData = [{"name": person.name, "cedula": person.cedula, "email": person.email, "phoneNumber": person.phoneNumber, "dateBirth": person.dateBirth, "address": person.address, "rol": person.rol, "userName": person.userName, "password": person.password} for person in persons]
